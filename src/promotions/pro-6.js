          ...
          <div className="card bg-dark">
            ...
            <div className="card-body">
              <h5 className="card-title">
                <strong>
                ฝากแบบไม่รับโบนัสขั้นต่ำ 1 บาท
        ฝากขั้นต่ำ 1 บาทไม่รับโบนัส ถอนได้เลย ไม่ต้องทำเทิร์น และยังได้รับ เงินคืน(CASHBACK) จากยอดเสียอีก 10% 
เงินคืน(CASHBACK) 10% ทำยอด 2 เท่า ถอนไม่อั้น
เงื่อนไข :
                </strong>
              </h5>
              <div className="card-text">
                <p>1. สมาชิกเลือกฝากแบบไม่รับโบนัส ฝากขั้นต่ำ 1 บาท ไม่ต้องทำเทิร์น</p>
                <p>
                  2.  เงินคืน(CASHBACK) 10% สูงสุด 1000 ทำยอด 2 เท่า ถอนไม่อั้น
                </p>
                <p>
                  3. ยอดถอนขั้นต่ำ 200 บาท
                </p>
