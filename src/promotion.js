    ...
    <div className="container text-center mb-6">
      ...
      <div className="row  justify-content-around">
        <div className="card1 col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-4 mb-3">
          <img src="img/promotion/pgslot_11-1080.jpg" className="card-img-top" alt="pg slot" title="โปรโมชั่น pgslot"></img>
          <div className="card-body">
            <h5 className="card-title">watafak88 แจกเครดิตฟรี PG SLOT</h5>
            <p className="card-text"></p>
            <a href="https://watafak88.com/#/credit" className="btn btn-bg1">
              รายละเอียด
            </a>
          </div>
        </div>
        ...
        <div className="card1 col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-4 mb-3">
          <img src="img/promotion/pgslot_1-1080.jpg" className="card-img-top" alt="pg slot" title="โปรโมชั่น pgslot"></img>
          <div className="card-body">
            <h5 className="card-title">
              โปรน้องใหม่ <strong>watafak88</strong> รับโบนัสสูงสุด 50%
            </h5>
            <p className="card-text"></p>
        ...
        <div className="card1 col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-4 mb-3">
          <img src="img/promotion/pgslot_2-1080.jpg" className="card-img-top" alt="pg slot" title="โปรโมชั่น pgslot"></img>
          <div className="card-body">
        ...
        <div className="card1 col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-4 mb-3">
          <img src="img/promotion/pgslot_3-1080.jpg" className="card-img-top" alt="pg slot" title="โปรโมชั่น pgslot"></img>
          <div className="card-body">
        ...
        <div className="card1 col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-4 mb-3">
          <img src="img/promotion/pgslot_4-1080.jpg" className="card-img-top" alt="pg slot" title="โปรโมชั่น pgslot"></img>
          <div className="card-body">
        ...
        <div className="card1 col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-4 mb-3">
          <img src="img/promotion/pgslot_5-1080.jpg" className="card-img-top" alt="pg slot" title="โปรโมชั่น pgslot"></img>
          <div className="card-body">
        ...
        <div className="card1 col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-4 mb-3">
          <img src="img/promotion/pgslot_6-1080.jpg" className="card-img-top" alt="pg slot" title="โปรโมชั่น pgslot"></img>
          <div className="card-body">
