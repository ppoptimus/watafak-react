...
export default function Footer_desktop() {
  return (
    <div>
      <footer
        id="footerdesktop"
        className=" d-none d-sm-none d-md-none d-lg-block mb-6"
            ...
            <div className="col-md-12 col-lg-8">
              <div className="row">
                ...
                <div className="col-md-6">
                  <img
                    src="img/download/logo-pg-slot.png"
                    className="img-fluid m-3 w-75"
                  ></img>
                </div>
              </div>
              ...
              <div className="row">
                ...
                <div className="col-md-12 col-lg-6">
                  <div className="footer-widget">
                    ...
                    <p>
                      ติดตามเรา Watafak88 ได้ที่ Line @watafak88
                      เพื่อรับสิทธิพิเศษและอัพเดตข่าวสารจากเรา
                    </p>
                  </div>
                </div>
              </div>
                ...
                <h6>
                  <marquee className="marquee1">
                    <i className="fa fa-trophy"></i>
                      ...
                      <b> PG SLOT</b> <b>watafak88</b>
                   
                    เปิดให้บริการแล้ววันนี้ สมาชิกใหม่รับโบนัสสูงสุด 50%
                    โปรเยอะทุกวัน ทุกช่วงเวลา&nbsp; &nbsp;
                    <i className="fa fa-trophy"></i>
